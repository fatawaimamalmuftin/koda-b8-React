...
export default function AdminDashboard() {
    return (
        <div className="bg-gray-100 text-gray-900 font-sans flex min-h-screen text-[13px] w-full">
            ...
            <aside className="w-[240px] min-w-[240px] bg-gray-900 flex flex-col fixed top-0 left-0 h-full z-[999]">
            ...
            <main className="ml-[240px] flex-1 flex flex-col min-h-screen">
                <header className="h-12 bg-white border-b border-gray-200 flex items-center justify-between px-7 sticky top-0 z-[90]">
                    ...
                    <div className="flex items-center gap-2.5">
                        <div className="relative w-8 h-8 border border-gray-200 rounded-lg flex items-center justify-center cursor-pointer bg-white">
                            ...
                            <div className="absolute top-1.5 right-1.5 w-[7px] h-[7px] bg-red-500 rounded-full border-[1.5px] border-white"></div>
                        </div>
                        <div className="flex items-center gap-1.5 border border-gray-200 rounded-lg px-2.5 py-1 cursor-pointer bg-white">
                            <div className="w-[22px] h-[22px] bg-[#1a73e8] rounded-full flex items-center justify-center text-white text-[10px] font-semibold">
                                A
                            </div>
                            <span>Admin</span>
                        </div>
                ...
                <div className="p-7 flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        <div className="bg-white border border-gray-200 rounded-xl p-5 flex flex-col gap-2.5">
                            <div className="flex justify-between items-start">
                                <span className="text-xs text-gray-500 leading-snug max-w-[140px]">Total Pendapatan (Bulan Ini)</span>
                            ...
                            <div className="text-[11px] flex items-center gap-1 text-green-500">
                                <ArrowUp className="w-[11px] h-[11px]" /> 18,2% dari bulan lalu
                            </div>
                        </div>

                        <div className="bg-white border border-gray-200 rounded-xl p-5 flex flex-col gap-2.5">
                            <div className="flex justify-between items-start">
                                <span className="text-xs text-gray-500 leading-snug max-w-[140px]">Pesanan Baru</span>
                            ...
                            <div className="text-[11px] flex items-center gap-1 text-green-500">
                                <ArrowUp className="w-[11px] h-[11px]" /> 12,5% dari bulan lalu
                            </div>
                        </div>

                        <div className="bg-white border border-gray-200 rounded-xl p-5 flex flex-col gap-2.5">
                            <div className="flex justify-between items-start">
                                <span className="text-xs text-gray-500 leading-snug max-w-[140px]">Pelanggan Aktif</span>
                            ...
                            <div className="text-[11px] flex items-center gap-1 text-green-500">
                                <ArrowUp className="w-[11px] h-[11px]" /> 0,1% dari bulan lalu
                            </div>
                        </div>

                        <div className="bg-white border border-gray-200 rounded-xl p-5 flex flex-col gap-2.5">
                            <div className="flex justify-between items-start">
                                <span className="text-xs text-gray-500 leading-snug max-w-[140px]">Produk Aktif</span>
                            ...
                            <div className="text-[11px] flex items-center gap-1 text-red-500">
                                <ArrowDown className="w-[11px] h-[11px]" /> 2,3% dari bulan lalu
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-4" style={{ gridTemplateColumns: '1fr 380px' }}>
                        <div className="bg-white border border-gray-200 rounded-xl p-5">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <span className="text-[11px] text-gray-500 bg-gray-100 px-2.5 py-0.5 rounded-md">12 Bulan Terakhir</span>
                            </div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-xl p-5">
                            ...
                            <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                                <div>
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">Budi Santoso · 28 Mei 2026</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-xs font-medium text-gray-900">Rp 900.000</div>
                                    <div className="text-[11px] text-gray-500 mt-0.5">2 item</div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                                <div>
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">Siti Rahayu · 28 Mei 2026</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-xs font-medium text-gray-900">Rp 450.000</div>
                                    <div className="text-[11px] text-gray-500 mt-0.5">1 item</div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                                <div>
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">Ahmad Maulana · 27 Mei 2026</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-xs font-medium text-gray-900">Rp 1.250.000</div>
                                    <div className="text-[11px] text-gray-500 mt-0.5">3 item</div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                                <div>
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">Rina Kusuma · 27 Mei 2026</div>
                                </div>
                                <div className="text-right">
                            ...
                            <div className="flex justify-between items-center py-2.5">
                                <div>
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">Danny Pratama · 26 Mei 2026</div>
                                </div>
                                <div className="text-right">
                        ...
                        <div className="bg-white border border-gray-200 rounded-xl p-5">
                            ...
                            <div className="flex items-center gap-2.5 py-2.5 border-b border-gray-100">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">136 terjual · Stok: 45</div>
                                </div>
                            ...
                            <div className="flex items-center gap-2.5 py-2.5 border-b border-gray-100">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">87 terjual · Stok: 15</div>
                                </div>
                            ...
                            <div className="flex items-center gap-2.5 py-2.5 border-b border-gray-100">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">312 terjual · Stok: 200</div>
                                </div>
                            ...
                            <div className="flex items-center gap-2.5 py-2.5 border-b border-gray-100">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">203 terjual · Stok: 80</div>
                                </div>
                            ...
                            <div className="flex items-center gap-2.5 py-2.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[11px] text-gray-500 mt-0.5">124 terjual · Stok: 30</div>
                                </div>
